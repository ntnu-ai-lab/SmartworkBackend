...
//TODO : Add navID to all model classes
/**
...
public class PatientTrace {
    ...
    public PatientTrace(String patientId, String questionnaireType, String status, LinkedHashMap similarPatients, TreeMap patientDetails) {
